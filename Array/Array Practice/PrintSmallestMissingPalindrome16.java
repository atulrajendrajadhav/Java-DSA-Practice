// 16. WAP to find the smallest missing palindrome number.
public class PrintSmallestMissingPalindrome16 {
    ...
    public static void printSumOfMissingNum(int[] num, int range){
        ...
        System.out.println("Smallest Missing Palindrome Element is: ");
