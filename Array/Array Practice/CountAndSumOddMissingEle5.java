// 5. WAP to print count and sum of odd missing digit in a a given array 

public class CountAndSumOddMissingEle5 {
    ...
    public static void printSumOfMissingNum(int[] num, int range){
        ...
        System.out.println("Missing Even elemet is: "+countMissingele+" Sum of this element is: "+prodOfMissing);
    }
